...
const go = () => {
  ...
  fetch(broadAIapiEndpoint + "/plan", {
    ...
    .then((plan) => {
      ...
      document.getElementById('plan').innerHTML += "<pre style='border:0;margin:0;padding:0;'>Executing the plan generated by BroadAI ... (" + plan.plan.length + " steps)</pre>";
      ...
      fetch(broadAIapiEndpoint + "/execute", {
        ...
        .then((results) => {
          ...
          document.getElementById('plan').innerHTML += "<h4>Plan steps & results:</h4>";
          ...
          fetch(broadAIapiEndpoint + "/response", {
            ...
            .then((resp) => {
              ...
              message += "</div>"
              message += "<pre style='border:0;margin:0;padding:0;'>Response status: " + resp.status + "</pre>";
