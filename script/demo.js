...
const go = () => {
  ...
  document.getElementById('plan').innerHTML = "<pre style='border:0;margin:0;padding:0;'>Generating a plan ...</pre>";
  ...
  fetch(broadAIapiEndpoint + "/plan", {
    ...
    .then((plan) => {
      ...
      document.getElementById('plan').innerHTML = "<pre style='border:0;margin:0;padding:0;'>Generating a plan ... " + plan.status + ".</pre>";
      document.getElementById('plan').innerHTML += "<pre style='border:0;margin:0;padding:0;'>" + plan.reason + "</pre>";
      document.getElementById('plan').innerHTML += "<hr><pre style='border:0;margin:0;padding:0;'>Executing the plan generated by BroadAI ... (" + plan.plan.length + " steps)</pre>";
      ...
      fetch(broadAIapiEndpoint + "/execute", {
        ...
        .then((results) => {
          ...
          document.getElementById('plan').innerHTML += "<hr><h4>Plan steps & results:</h4>";
          ...
          document.getElementById('message').innerHTML = "<pre style='border:0;margin:0;padding:0;'>Almost done ...</pre>";
          ...
          fetch(broadAIapiEndpoint + "/response", {
            ...
            .then((resp) => {
              ...
              message += "</div>"
              message += "<hr><pre style='border:0;margin:0;padding:0;'>Response status: " + resp.status + "</pre>";
              message += "<pre style='border:0;margin:0;padding:0;'>" + resp.reason + "</pre>";
