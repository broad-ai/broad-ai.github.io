...
const go = () => {
  ...
  fetch(broadAIapiEndpoint + "/plan", {
    ...
    .then((plan) => {
      ...
      document.getElementById('plan').innerHTML += "<p> Status: " + plan.status + "</p><br>";
      document.getElementById('plan').innerHTML += "<p>Executing the plan generated by BroadAI ... (" + plan.plan.length + " steps)</p>";
      document.getElementById('plan').innerHTML += "<p> Notes: " + plan.reason + "</p><br>"
      ...
      fetch(broadAIapiEndpoint + "/execute", {
        ...
        .then((results) => {
          ...
          document.getElementById('message').innerHTML = "<p>Almost done ...</>";
          ...
          fetch(broadAIapiEndpoint + "/response", {
            ...
            .then((resp) => {
              ...
              message += "</div>"
              message += "<pre style='border:0;'> Status: " + resp.status + "</pre><br>";
              message += "<pre style='border:0;'> Notes: " + resp.reason + "</pre>";
