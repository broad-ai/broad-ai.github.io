...
const go = () => {
  ...
  document.getElementById('plan').innerHTML = "<hr style='border:1px dotted;color:#eee;margin:2px;padding:0;'><pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>Planning ...</pre>";
  ...
  fetch(broadAIapiEndpoint + "/plan", {
    ...
    .then((plan) => {
      ...
      document.getElementById('plan').innerHTML = "<hr style='border:1px dotted;color:#eee;margin:2px;padding:0;'><pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>Plan " + plan.status + ".</pre>";
      document.getElementById('plan').innerHTML += "<hr style='border:1px dotted;color:#eee;margin:2px;padding:0;'><pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>" + plan.reason + "</pre>";
      document.getElementById('plan').innerHTML += "<hr style='border:1px dotted;color:#eee;margin:2px;padding:0;'><pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>Executing " + plan.plan.length + " steps of the plan.</pre>";
      ...
      fetch(broadAIapiEndpoint + "/execute", {
        ...
        .then((results) => {
          ...
          document.getElementById('plan').innerHTML += "<hr style='border:1px dotted;color:#eee;margin:2px;padding:0;'><h4>Plan steps & results:</h4>";
          ...
          fetch(broadAIapiEndpoint + "/response", {
            ...
            .then((resp) => {
              ...
              message += "</div>"
              message += "<hr style='border:1px dotted;color:#eee;margin:2px;padding:0;'><pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>Response: " + resp.status + "</pre>";
