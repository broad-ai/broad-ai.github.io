...
const go = () => {
  ...
  document.getElementById('plan').innerHTML = "<pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>Generating a plan ...</pre>";
  ...
  fetch(broadAIapiEndpoint + "/plan", {
    ...
    .then((plan) => {
      ...
      document.getElementById('plan').innerHTML = "<pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>Generating a plan ... " + plan.status + ".</pre>";
      document.getElementById('plan').innerHTML += "<pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>" + plan.reason + "</pre>";
      document.getElementById('plan').innerHTML += "<pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>Executing the plan generated by BroadAI ... (" + plan.plan.length + " steps)</pre>";
        ...
        .then((results) => {
          ...
          fetch(broadAIapiEndpoint + "/response", {
            ...
            .then((resp) => {
              ...
              message += "</div>"
              message += "<pre style='border:0;margin:0;padding:0;text-wrap:wrap;'>Response status: " + resp.status + "</pre>";
