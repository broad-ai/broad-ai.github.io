...
const go = () => {
  ...
  fetch(broadAIapiEndpoint + "/ask", {
    ...
    .then((data) => {
      ...
      document.getElementById('plan').innerHTML += "<h4>Plan generated by BroadAI:</h4>" + "<ol>";
      data.plan.forEach((step) => {
        document.getElementById('plan').innerHTML += "<li>" + step.objective + "</li>>";
        document.getElementById('plan').innerHTML += "<ul><li>" + JSON.stringify(step.result) + "</li></ul>";
      });
