...
const go = () => {
  ...
  document.getElementById('message').innerHTML = "<pre style='border:0;'>Working ...</pre>";
  document.getElementById('notes').disabled = true;
  document.getElementById('btngo').hidden = true;
  // ...

  document.getElementById('plan').innerHTML = "<pre style='border:0;'>Generating a plan ...</pre>";
  ...
  fetch(broadAIapiEndpoint + "/plan", {
    ...
    .then((plan) => {
      ...
      document.getElementById('plan').innerHTML = "<pre style='border:0;'>Executing the plan generated by BroadAI ... (" + plan.length + " steps)</pre>";
      ...
      fetch(broadAIapiEndpoint + "/execute", {
        ...
        .then((results) => {
          ...
          document.getElementById('message').innerHTML = "<pre style='border:0;'>Almost done ...</pre>";
